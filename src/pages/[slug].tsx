...
export default function Page({ heading, body }: PageTemplateProps) {
  ...
  //(retorna um loading enquanto estiver sendo criado)
...
//getInitialProps => serve para buscar dados da página (props) -runtime - toda requisição (bundle também vem para o client)
